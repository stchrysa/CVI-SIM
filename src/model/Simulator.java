...
public class Simulator {
	...
	public Simulator() {
		...
		//initial simulator entries (Hardcoded)
		Substrate s = DefaultSubstrates.constructFEDERICASubstrate("FEDERICA");
		substrates.add(s);
		s = DefaultSubstrates.constructTestSubstrate("TestSubstrate");
		substrates.add(s);		
		Request r = new Request("jra23Request");
		r.constructJRA23Request();
		requests.add(r);
		Algorithm a = new Algorithm("GSP-Exact");
		algorithms.add(a);
		a = new Algorithm("GSP-ILS");		
		algorithms.add(a);
		a = new Algorithm("NCM-Exact");		
		algorithms.add(a);
		a = new Algorithm("NCM-ILS");		
		algorithms.add(a);
		a = new Algorithm("GMCF-Exact");		
		algorithms.add(a);
		a = new Algorithm("GMCF-ILS");		
		algorithms.add(a);
	}
