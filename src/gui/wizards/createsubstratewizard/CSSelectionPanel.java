...
public class CSSelectionPanel extends JPanel {
    ...
    public CSSelectionPanel() {
        ...
        title.setText("Select how to create substrates");
	...
	private JPanel getContentPanel() {
        ...
        // random option
        randomButton.setText("Create random substrates");
        randomButton.setSelected(true);
        buttonGroup.add(randomButton);
        jPanel1.add(randomButton);
        jPanel1.add(new JLabel());
        // import option
        importButton.setText("Import substrates from file");
        buttonGroup.add(importButton);
        jPanel1.add(importButton);
        jPanel1.add(new JLabel());
        // design option
        designButton.setText("Design substrate graphically");
