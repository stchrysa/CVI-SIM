...
import gui.components.MouseMenus.AvailableBandwidthDisplay;
import gui.components.MouseMenus.AvailableCpuDisplay;
import gui.components.MouseMenus.AvailableDiskSpaceDisplay;
import gui.components.MouseMenus.AvailableMemoryDisplay;
import gui.components.MouseMenus.AvailableVlansDisplay;
...
public class PopupVertexEdgeMenuMousePlugin<V, E> extends AbstractPopupGraphMousePlugin {
	...
	private void updateVertexMenu(V v, VisualizationViewer vv, Point2D point) {
    	...
    	for (Component comp: menuComps) {
    		...
    		else if (comp instanceof DiskSpaceDisplay) {
        		vertexPopup.remove(comp);
            }
